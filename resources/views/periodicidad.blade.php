...
<div class="container">
    ...
    <div class="col-md-6">
        <br>
            <div class="card">
                <div class="card-header text-white bg-dark mb-3">{{ __('Registro de periodicidad') }}</div>
    ...
    <div class="modal-dialog" role="document">
        ...
        <br>
            <div class="card">
                <div class="card-header text-white bg-dark mb-3">{{ __('Listado de periodicidades') }}</div>
