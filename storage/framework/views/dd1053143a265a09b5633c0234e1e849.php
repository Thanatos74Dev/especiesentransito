...
<div class="container">
    ...
    <div class="col-md-6">
        <br>
            <div class="card">
                <div class="card-header text-white bg-dark mb-3"><?php echo e(__('Registro de especialidad')); ?></div>
    ...
    <button type="submit" class="btn btn-primary float-right">
        ...
        <br>
            <div class="card">
                <div class="card-header text-white bg-dark mb-3"><?php echo e(__('Listado de especialidades')); ?></div>
        ...
        <table class="table table-striped table-hover" id="especialidades" style='text-align: center; vertical-align: middle;'>
            ...
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td style="vertical-align: middle;"><?php echo e($d->esp_id); ?></td>
                    <td style="vertical-align: middle;"><?php echo e($d->esp_nombre); ?></td>
                    <td align="justify" class="d-none d-sm-block"><?php echo e($d->esp_descripcion); ?></td>
                    ...
                    <td style="vertical-align: middle;" class="d-none d-md-block"><?php echo e($d->esp_fecha_registro); ?></td>
                </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bioequipos\resources\views/especialidades.blade.php ENDPATH**/ ?>